...
This repository keeps most human-facing documentation in `wiki/`.

This `docs/` directory exists to keep legacy links working and to provide stable entry points.

## Index
- Architecture: `docs/ARCHITECTURE.md` (see also `wiki/Architecture.md`)
...
- MQ broker interaction: `docs/redis-mq-broker-interaction.md` (see also `wiki/MQ-Broker-Interaction.md`)
- MQ partitioning: `docs/redis-mq-partitioning.md` (see also `wiki/MQ-Design.md`)
- Registry usage: `docs/redis-registry-usage.md` (see also `wiki/Registry-Guide.md`)
